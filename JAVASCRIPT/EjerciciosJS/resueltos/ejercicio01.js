...
// muestra: Mi superhéroe favorito es: Hulk

// 2. Define un número
let numeroFavorito = 50;
console.log("Mi número favorito es: ", numeroFavorito);
// muestra: Mi número favorito es: 50
...
// muestra: La suma de altura y longitud es: 15

// 5. Imprime los todos los resultados finales
